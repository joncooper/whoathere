...
rg -n "[^[:ascii:]]" docs/product-build-run/macos-local-release-readiness.md whoathere/crates/whoathere-cli/src/lib.rs whoathere/crates/whoathere-macos-vm/src/lib.rs
rg -n "[^[:ascii:]]" scripts/whoathere-package-macos-preview.sh docs/product-build-run/macos-local-first-preview-runbook.md docs/product-build-run/macos-local-release-readiness.md
...
sh -n scripts/whoathere-package-macos-preview.sh
rg -n "[^[:ascii:]]" scripts/whoathere-install-macos-preview.sh scripts/whoathere-package-macos-preview.sh docs/product-build-run/macos-local-first-preview-runbook.md docs/product-build-run/macos-local-release-readiness.md
git diff --check
scripts/whoathere-package-macos-preview.sh
