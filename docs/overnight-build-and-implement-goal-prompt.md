...
Important context:
- Treat /Users/jdc/src/whoathere/docs as authoritative product-planning input.
- The repo is dedicated to the WhoaThere supply-chain security product; do not introduce unrelated app code.
...
Read first:
1. docs/README.md
2. docs/outputs/final-goal-pack-execution-summary.md
3. docs/outputs/GOAL-09/remediation-execution-summary.md
4. docs/outputs/GOAL-09/phase-gate-scorecard.md
5. docs/outputs/GOAL-09/primary-owner-test-matrix.md
6. docs/outputs/GOAL-09/interface-schema-contracts.md
7. docs/outputs/GOAL-10/downstream-goal-execution-addendum.md
8. docs/outputs/GOAL-10/quality-verification-manifest.md
...
1. docs/build-plans/phase-1-mvp-local-cli-build-plan.md
2. docs/build-plans/phase-2-advanced-isolation-build-plan.md
3. docs/build-plans/phase-3-enterprise-vault-build-plan.md
4. docs/build-plans/phase-4-advanced-detonation-build-plan.md
5. docs/build-plans/cross-phase-dependency-and-gate-map.md
6. docs/build-plans/implementation-backlog.md
7. docs/build-plans/initial-repo-file-plan.md
8. docs/build-plans/overnight-build-summary.md
...
Run at least 3 and at most 5 improvement passes over docs/build-plans/.

For each pass, create:
- docs/build-plans/quality/pass-N-rubric.md
- docs/build-plans/quality/pass-N-evaluation.md
- docs/build-plans/quality/pass-N-improvement-plan.md
- docs/build-plans/quality/pass-N-execution-notes.md
- docs/build-plans/quality/pass-N-verification.md
...
- Do not introduce unrelated app code while implementing WhoaThere.
