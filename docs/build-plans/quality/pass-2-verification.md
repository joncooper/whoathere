...
```sh
rg -n "No public fallback|No unapproved artifact serving|Break-glass|research_required|validation_pending|Blocked Implementation" docs/build-plans
rg -n "Production Vault promotion implemented|Cloudflare stale serving implemented|GA macOS containment implemented" docs/build-plans whoathere
```
