...
rg -n "[^[:ascii:]]" docs/whoathere/product-build-run/macos-vm-goal-4-project-hardening-checkpoint.md whoathere/helpers/macos-vm-helper/scripts/validate-project-detonation.sh whoathere/crates/whoathere-cli/src/lib.rs
```
