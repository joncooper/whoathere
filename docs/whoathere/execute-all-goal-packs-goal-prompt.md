...
```text
Execute the WhoaThere goal packs in /Users/jdc/src/whoathere/docs/whoathere.
...
Important context:
- The current repo is greenfield for the supply-chain security product; existing Swift timer app files are unrelated and should not be refactored.
...
1. Read /Users/jdc/src/whoathere/docs/whoathere/README.md first.
2. Read /Users/jdc/src/whoathere/docs/whoathere/interfaces-and-contracts.md, /Users/jdc/src/whoathere/docs/whoathere/acceptance-test-matrix.md, and /Users/jdc/src/whoathere/docs/whoathere/goal-pack-completion-checklist.md.
...
10. For each goal pack, create an output directory under /Users/jdc/src/whoathere/docs/whoathere/outputs/GOAL-XX/.
...
12. For each goal pack, create /Users/jdc/src/whoathere/docs/whoathere/outputs/GOAL-XX/completion-record.md using the template in goal-pack-completion-checklist.md.
...
14. At the end, create /Users/jdc/src/whoathere/docs/whoathere/outputs/final-goal-pack-execution-summary.md with:
    - Completed goal list.
