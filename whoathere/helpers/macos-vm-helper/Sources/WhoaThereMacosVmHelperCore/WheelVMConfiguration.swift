...
public struct WheelVMConfigurationContract: Equatable, Sendable {
...
public func wheelVMConfigurationContract(
    base: LockedWheelRunBase,
    clone: DisposableWheelRunClone
) throws -> WheelVMConfigurationContract {
    ...
    return WheelVMConfigurationContract(
        ...
        guestVSOCKPort: wheelGuestVSOCKPortV1
    )
}

public func buildWheelScenarioConfiguration(
    base: LockedWheelRunBase,
    clone: DisposableWheelRunClone
) throws -> VZVirtualMachineConfiguration {
    let contract = try wheelVMConfigurationContract(base: base, clone: clone)
