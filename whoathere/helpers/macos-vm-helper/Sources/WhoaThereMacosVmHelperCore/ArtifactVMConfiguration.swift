...
public struct ArtifactVMConfigurationContract: Equatable, Sendable {
...
public func artifactVMConfigurationContract(
    base: LockedArtifactRunBase,
    clone: DisposableArtifactRunClone
) throws -> ArtifactVMConfigurationContract {
    ...
    return ArtifactVMConfigurationContract(
...
public func buildArtifactScenarioConfiguration(
    base: LockedArtifactRunBase,
    clone: DisposableArtifactRunClone
) throws -> VZVirtualMachineConfiguration {
    let contract = try artifactVMConfigurationContract(base: base, clone: clone)
