...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if matches!(
        ...
        println!(
            "{{\"backend_identity_sha256\":\"{}\",\"challenge_sha256\":\"{}\",\"execution_authority\":false,\"network_evidence_payload_sha256\":\"{}\",\"package_execution\":false,\"receipt_sha256\":\"{}\",\"run_spec_sha256\":\"{}\",\"schema_version\":\"whoathere.linux_vz_guest_receipt_verification.v1\",\"status\":\"verified\",\"sync_back\":false}}",
            backend.identity_sha256_v1()?,
            verified.challenge_sha256(),
            evidence.payload_sha256(),
            Sha256Digest::from_bytes(&receipt),
