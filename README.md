...
first twenty-six physical inert guest-plus-host conformance cases passed on one measured identity
...
[escaped-session checkpoint](docs/product-build-run/artifact-native-linux-vz-escaped-session-checkpoint-2026-07-12.md).
