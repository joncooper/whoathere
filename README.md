...
first twenty-four physical inert guest-plus-host conformance cases passed on one measured identity
...
[timeout checkpoint](docs/product-build-run/artifact-native-linux-vz-timeout-checkpoint-2026-07-12.md).
