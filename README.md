...
first sixteen physical inert guest-plus-host conformance cases passed on one measured identity with
...
[public-address-connect checkpoint](docs/product-build-run/artifact-native-linux-vz-public-address-connect-checkpoint-2026-07-12.md).
