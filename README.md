...
first twenty-five physical inert guest-plus-host conformance cases passed on one measured identity
...
[TERM-resistance checkpoint](docs/product-build-run/artifact-native-linux-vz-term-resistance-checkpoint-2026-07-12.md).
